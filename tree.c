...
//-------------------------------------------------------------
    ...
    Node* FindParent(int key)
    {
        ...
        {							  //eventually becomes NULL & code hang!
            if (key < pCurrent->iData)  //go left sub-tree if key is smaller
                pCurrent = pCurrent->pLeftChild;
    ...
    void del(int key)
    {
        Node* pCurrent = find(key);

        if (pCurrent != NULL)
        {
            if ((pCurrent->pLeftChild == NULL) && (pCurrent->pRightChild == NULL))
            {
                Node* pParent = FindParent(pCurrent->iData);
            ...
            else if ((pCurrent->pLeftChild == NULL) && (pCurrent->pRightChild != NULL))
            {
                Node* pParent = FindParent(pCurrent->iData);
            ...
            else 
            {
                ...
                if (pNext->pRightChild != NULL) //find biggest node in left sub-tree
                {
                    ...
                    temp = pCurrent->iData;
                    pCurrent->iData = pMax->iData;
                    pMax->iData = temp;
                    pParent->pRightChild = pMax->pLeftChild;
                    delete pMax;
                }
